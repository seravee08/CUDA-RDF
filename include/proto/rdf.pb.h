...
class RDFParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:rdf.RDFParameter) */ {
 public:
  RDFParameter();
  ...
  inline RDFParameter* New() const { return New(NULL); }

  RDFParameter* New(::google::protobuf::Arena* arena) const;
  ...
  void InternalSwap(RDFParameter* other);
  private:
  ...
  static const Col RED =
    RDFParameter_Col_RED;
  static const Col GREEN =
    RDFParameter_Col_GREEN;
  static const Col BLUE =
    RDFParameter_Col_BLUE;
  static const Col BLACK =
    RDFParameter_Col_BLACK;
  static const Col WHITE =
    RDFParameter_Col_WHITE;
  static const Col YELLOW =
    RDFParameter_Col_YELLOW;
  static const Col PURPLE =
    RDFParameter_Col_PURPLE;
  static const Col AZURE =
    RDFParameter_Col_AZURE;
  ...
  bool has_num_images() const;
  void clear_num_images();
  static const int kNumImagesFieldNumber = 1;
  ::google::protobuf::int32 num_images() const;
  void set_num_images(::google::protobuf::int32 value);
  ...
  int num_pixels_size() const;
  void clear_num_pixels();
  static const int kNumPixelsFieldNumber = 3;
  ::google::protobuf::int32 num_pixels(int index) const;
  void set_num_pixels(int index, ::google::protobuf::int32 value);
  void add_num_pixels(::google::protobuf::int32 value);
  ...
  ::rdf::RDFParameter_Col color(int index) const;
  void set_color(int index, ::rdf::RDFParameter_Col value);
  void add_color(::rdf::RDFParameter_Col value);
  const ::google::protobuf::RepeatedField<int>& color() const;
  ::google::protobuf::RepeatedField<int>* mutable_color();

  // optional int32 num_trees = 5 [default = 10];
  bool has_num_trees() const;
  ...
  bool has_num_depth() const;
  void clear_num_depth();
  static const int kNumDepthFieldNumber = 6;
  ::google::protobuf::int32 num_depth() const;
  void set_num_depth(::google::protobuf::int32 value);

  // optional int32 max_span = 7 [default = 200];
  bool has_max_span() const;
  void clear_max_span();
  static const int kMaxSpanFieldNumber = 7;
  ::google::protobuf::int32 max_span() const;
  void set_max_span(::google::protobuf::int32 value);

  // optional int32 space_size = 8 [default = 400];
  bool has_space_size() const;
  void clear_space_size();
  static const int kSpaceSizeFieldNumber = 8;
  ::google::protobuf::int32 space_size() const;
  void set_space_size(::google::protobuf::int32 value);
  ...
  bool has_num_thresholds() const;
  void clear_num_thresholds();
  static const int kNumThresholdsFieldNumber = 10;
  ::google::protobuf::int32 num_thresholds() const;
  void set_num_thresholds(::google::protobuf::int32 value);

  // optional string input_path = 11 [default = "./data"];
  bool has_input_path() const;
  ...
  bool has_out_name() const;
  void clear_out_name();
  static const int kOutNameFieldNumber = 13;
  const ::std::string& out_name() const;
  void set_out_name(const ::std::string& value);
  void set_out_name(const char* value);
  void set_out_name(const char* value, size_t size);
  ::std::string* mutable_out_name();
  ::std::string* release_out_name();
  void set_allocated_out_name(::std::string* out_name);

  // optional string test_input_path = 14 [default = "./test_data"];
  bool has_test_input_path() const;
  void clear_test_input_path();
  static const int kTestInputPathFieldNumber = 14;
  const ::std::string& test_input_path() const;
  void set_test_input_path(const ::std::string& value);
  void set_test_input_path(const char* value);
  void set_test_input_path(const char* value, size_t size);
  ::std::string* mutable_test_input_path();
  ::std::string* release_test_input_path();
  void set_allocated_test_input_path(::std::string* test_input_path);

  // optional string test_output_path = 15 [default = "./test_new_data"];
  bool has_test_output_path() const;
  void clear_test_output_path();
  static const int kTestOutputPathFieldNumber = 15;
  const ::std::string& test_output_path() const;
  void set_test_output_path(const ::std::string& value);
  void set_test_output_path(const char* value);
  void set_test_output_path(const char* value, size_t size);
  ::std::string* mutable_test_output_path();
  ::std::string* release_test_output_path();
  void set_allocated_test_output_path(::std::string* test_output_path);

  // optional float min_prob = 16 [default = 0.5];
  bool has_min_prob() const;
  void clear_min_prob();
  static const int kMinProbFieldNumber = 16;
  float min_prob() const;
  void set_min_prob(float value);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr out_name_;
  static ::std::string* _default_test_input_path_;
  ::google::protobuf::internal::ArenaStringPtr test_input_path_;
  static ::std::string* _default_test_output_path_;
  ::google::protobuf::internal::ArenaStringPtr test_output_path_;
  float min_prob_;
